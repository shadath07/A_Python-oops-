...
# Randomly generate a 4-digit number. Ask the user to guess a 4-digit number(Digits should not be repeated). 
...
def play_cows_and_bulls():
    ...
    while True:
        ...
        if len(guess) != 4 or not guess.isdigit() or len(set(guess)) != 4:
            print("Invalid input! Please enter a valid 4-digit number with non-repeated digits.")
            continue
        guesses += 1
